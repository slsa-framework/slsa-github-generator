...
- Support was added for authenticating using [Workload Identity Federation](https://cloud.google.com/iam/docs/workload-identity-federation) with [Google Artifact Registry](https://cloud.google.com/artifact-registry) and Google Container Registry](https://cloud.google.com/container-registry). Users can use this new feature by using the [`gcp-workload-identity-provider` and `gcp-service-account` inputs](https://github.com/slsa-framework/slsa-github-generator/blob/main/internal/builders/container/README.md#workflow-inputs)
