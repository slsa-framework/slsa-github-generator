...
| `upload-tag-name`    | no       |                                         | Set when `upload-assets` is true and workflow is **not** triggered by a release/tag. Can also be used to override the default release name on tagged events.
