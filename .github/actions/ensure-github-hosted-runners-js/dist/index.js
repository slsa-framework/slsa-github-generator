...
exports.getSelfHostedRunnerLabels = exports.getJobLabels = void 0;
function getJobLabels(octokit, owner, repo) {
...
function getSelfHostedRunnerLabels(octokit, owner, repo) {
    return __awaiter(this, void 0, void 0, function* () {
        const selfHostedRunners = yield octokit.paginate(octokit.rest.actions.listSelfHostedRunnersForRepo, {
            owner,
            repo,
        });
...
exports.getSelfHostedRunnerLabels = getSelfHostedRunnerLabels;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.run = exports.getUsedSelfHostedRunnerLabels = void 0;
...
uses: slsa-framewrok/slsa-github-generator/.github/workflows/generator_generic_slsa3.yml'
 ...
 ```
*/
function getUsedSelfHostedRunnerLabels(token, owner, repo) {
    return __awaiter(this, void 0, void 0, function* () {
        const octokit = new rest_1.Octokit({ auth: token });
        const [jobLabels, selfHostedRunnerLabels] = yield Promise.all([
            (0, labels_1.getJobLabels)(octokit, owner, repo),
            (0, labels_1.getSelfHostedRunnerLabels)(octokit, owner, repo),
        ]);
        const commonLabels = [...jobLabels].filter((label) => selfHostedRunnerLabels.has(label));
        return commonLabels;
    });
}
exports.getUsedSelfHostedRunnerLabels = getUsedSelfHostedRunnerLabels;
function run() {
    return __awaiter(this, void 0, void 0, function* () {
